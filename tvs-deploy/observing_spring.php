<?php
/**
 * TVS Spring Observing Program
 * Converted from observing_spring.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Spring Observing Program - Tri-Valley Stargazers';
$pageId = 'm_activities';
...
<p>
    Targets + log: <a href="observing_spring_spreadsheet.xls">Excel format</a><br>
    Target list: <a href="observing_spring_list.pdf">PDF format</a><br>
    Logging form: <a href="observing_spring_log.pdf">PDF format</a>
</p>
