<?php
/**
 * TVS Winter Observing Program
 * Converted from observing_winter.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Winter Observing Program - Tri-Valley Stargazers';
$pageId = 'm_activities';

include __DIR__ . '/includes/templates/header.php';
?>

<h1 class="title" style="width:500px;">Winter Observing Program</h1>
...
<p>
    The targets for this program are at these links:
    <a href="observing_winter_targets.pdf" title="Targets">target list</a> and
    <a href="observing_winter_log.pdf" title="Logging form">log</a>.
</p>
...
<p>
    ...
    <a href="https://skyandtelescope.org/observing/secrets-of-deep-sky-observing/">
