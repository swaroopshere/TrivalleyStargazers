<?php
/**
 * TVS Observing Logging Guide
 * Converted from observing_logging.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Observing Log Guide - Tri-Valley Stargazers';
$pageId = 'm_activities';
...
<ul>
    ...
    <li>What is the object's shape (round, oval, etc.)?</li>
    <li>What is its color?</li>
    <li>Is it uniformly lit or condensed?</li>
    <li>Can you see a galaxy's arms?</li>
    <li>Can you resolve individual stars? How dim?</li>
    <li>Is this part of a larger group (galaxy cluster, star cloud, etc.)?</li>
    <li>Do filters help?</li>
</ul>
