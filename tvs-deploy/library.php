...
/**
 * TVS Lending Library
 * Converted from library.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Library - Tri-Valley Stargazers';
$pageId = 'm_resources';
...
<div class="content" style="width:930px;">
    ...
    <p>
        ...
        charts for beginners as well as advanced observers.
    </p>
    ...
    <p>
        ...
        damage an item the club would like to be reimbursed for replacing the item.
    </p>
</div>
