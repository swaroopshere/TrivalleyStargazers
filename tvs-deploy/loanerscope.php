<?php
/**
 * TVS Loaner Scope Program Page
 *
 * Information about telescope rental program
 * Converted from loanerscope.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Loaner Scopes - Tri-Valley Stargazers';
$pageId = 'm_resources';
...
<a name="Anchor"></a>
<h1 class="title" style="width: 329px;">TVS Loaner Scope Program</h1>

<table width="478" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="26"></td>
        <td width="451" colspan="2" valign="top" align="left">
            <div align="left">

                <h2 class="subtitle">TVS Loaner Scopes</h2>
                <h3 class="subtitle">Librarian: Ron Kane</h3><br>

                <p>TVS has a loaner scope program available to its members.</p>
                ...
                <p>
                    ...
                    <script type="text/javascript">
                        contact("telescopes", "trivalleystargazers.org", "Ron Kane");
                    </script>.
                </p>
                ...
                <ul class="bullets">
                    <li>
                        <span>
                            ...
                            websites available to provide guidance, or ask your friendly TVS club member!
                            <br><br>
                            ...
                            See
                            <a href="https://optcorp.com/blogs/astronomy/beginners-guide-dobsonians" target="_blank" title="guide">here</a>
                            for a beginner's guide to using dobsonians.<br><br>

                            <img src="images/reddob.gif" alt="Red DOB" height="234" width="144" border="0">
                        </span>
                    </li>

                    <li>
                        <span>
                            <strong>Orion SkyQuest XT8i Computerized IntelliScope Telescope</strong><br><br>
                            ...
                            these telescopes is $100.<br><br>

                            See the
                            <a href="https://www.trivalleystargazers.org/Orion XT8i manual 29226_06-12.pdf"
                               target="_blank" title="See instructions">instructions</a>
                            for using this telescope.<br><br>

                            The computer module "handbox" instructions are:
                            <a href="https://www.trivalleystargazers.org/Orion Computer 29229_08-11.pdf" target="_blank"
                               title="See Handbox Instructions">handbox instructions</a><br><br>

                            <img src="images/orion_xt8i.jpg" alt="Orion XT8i" height="250" width="167" border="0"><br><br>
                        </span>
                    </li>

                    <li>
                        <span>
                            <strong>Meade LightSwitch 8-inch SCT</strong><br><br>
                            ...
                            <img src="images/Meade lightswitch 8.jpg" alt="Meade LightSwitch" height="270" width="166" border="0"><br><br>
                        </span>
                    </li>

                    <li>
                        <span>
                            <strong>Equatorial Mount SCTs</strong><br><br>
                            ...
                            <img src="images/Celestron-8inch-AVX.jpg" alt="Celestron AVX" height="274" width="274" border="0"><br><br>
                            ...
                            <img src="images/Vixen_Orion_Mt_sm.jpeg" alt="Orion EQ-G Mount" height="400" width="300" border="0"><br><br>
                        </span>
                    </li>
                </ul>
                ...
                <p>We also have an assortment of non-telescope items for rent, including:</p>
                ...
                <ul class="bullets">
                    <li>
                        <span>
                            ...
                            <br><br>
                            <img src="images/Lunt_Binoculars.jpeg" alt="Lunt Binoculars" height="300" width="200" border="0">
                            <br><br>

                            8x56 Celestron binoculars.<br><br>
