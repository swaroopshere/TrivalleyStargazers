...
$pageTitle = 'Tri-Valley Stargazers H2O Observatory';
$pageId = 'm_sites';
...
<h1 class="title">H2O (Hidden Hill Observatory)</h1>
  ...
  <div class="content">
    ...
    member, visit our <a href="h2oagreement.php">user agreement</a> web page. <br><br>
   ...
   <b>See <a href="donors.php" title="List of donors">here</a> for a list of donors.</b><br><br>
