<?php
/**
 * TVS Autumn Observing Program
 * Converted from observing_autumn.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'Autumn Observing Program - Tri-Valley Stargazers';
$pageId = 'm_activities';

include __DIR__ . '/includes/templates/header.php';
?>

<h1 class="title" style="width:500px;">Autumn Observing Program</h1>
...
<p>
    ...
    <a href="observing_autumn_spreadsheet.xls" title="download targets and log">spreadsheet</a>
    ...
    <a href="observing_autumn_targets.pdf" title="Targets">target list</a> and
    <a href="observing_autumn_log.pdf" title="Logging form">log</a>.
</p>
...
<p>
    ...
    <a href="https://skyandtelescope.org/observing/secrets-of-deep-sky-observing/" target="_blank">
        https://skyandtelescope.org/observing/secrets-of-deep-sky-observing</a>.
</p>
...
<p>
    Targets + log: <a href="observing_autumn_spreadsheet.xls">Excel format</a><br>
    Target list: <a href="observing_autumn_targets.pdf">PDF format</a><br>
    Logging form: <a href="observing_autumn_log.pdf">PDF format</a>
</p>
