<?php
/**
 * TVS H2O User Agreement Page
 *
 * Information about H2O site access and user agreement
 * Converted from h2oagreement.shtml
 */

require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

$pageTitle = 'H2O Agreement - Tri-Valley Stargazers';
$pageId = 'm_sites';
...
<div class="content" style="width:930px;">
    ...
    <p>
        ...
        etc. It is not open to the public. Uninvited visitors are not allowed.
    </p>
    ...
    <p>
        ...
        authorized members on the hilltop.
    </p>
    ...
    <p>The procedure for members to gain access to the site is:</p>

    <ol>
        <li>Make sure you are a member in good standing.</li>
        <li>
    ...
    <p>You will not find the directions to Hidden Hill Observatory here, or anywhere else either.</p>
    ...
    <p>
        ...
        directions before leaving, as they must follow you up there.
    </p>
    ...
    <p>Currently Patron members can use the Jack Marling Telescope.</p>
    ...
    <p>
        ...
        available for public viewing during the open houses.
    </p>

    <p>
        <b>The Jack Marling telescope was destroyed in a recent fire. We will replace it soon with
        comparable scope. In the mean time, patron membership is no longer available.</b>
    </p>
    ...
    <p>For a PDF version of the Agreement Form, click <a class="boldLink" href="pdfs/h2oagree.pdf">here</a></p>

    <p>
        In exchange for the opportunity to use the Hidden Hill Observatory (H2O) observing site,
        I ________________________, TVS member in good standing, agree to:
    </p>
    ...
    <p>Signature____________________________ Date _______________ Key number________</p>
    <p>Print Name: _____________________________________________ Issued ____________</p>
    <p>Address: ________________________________________________</p>
    <p>________________________________________________________</p>
    <p>Phone____________________ e-mail _________________________</p>
    <br>

    <p>
        Return this form to TVS P.O. Box 2476, Livermore CA 94551, or directly to the key
        master, or bring it to a regular TVS general meeting.
    </p>
    ...
    <p>These rules may be changed by TVS at any time.</p>
    ...
    <p>
        ...
        end quickly. This is not a public park. We are there only at the invitation of the owners.
    </p>
    ...
    <p>
        ...
        tenants, and workers, and 2) safety and consideration of others.
    </p>
    ...
    <p>
        ...
        course feel free to engage in conversation if you happen to meet them when they are not busy.
    </p>
    ...
    <p>
        ...
        than demonstrating that you were right.
    </p>
    ...
    <p>
        ...
        ranchers driving more quickly, we will always drive slowly.
    </p>
    ...
    <p>
        ...
        gate so that one of the other locks in the chain can no longer be used to open the gate.
    </p>
    ...
    <p>
        ...
        extremely cautious in unacceptable.
    </p>
    ...
    <p>
        ...
        You also risk meeting wild animals, spooking livestock, and possibly getting shot.
    </p>

    <p>
        No alcoholic beverages or other intoxicating substances (legal or illegal). The use of intoxicating substances
        voids our insurance, interferes with the observance of the other rules and makes driving less safe.
    </p>
    ...
    <p>
        ...
        and they may annoy livestock or otherwise be a nuisance with their noise.
    </p>
    ...
    <p>
        ...
        attend an open house, or be escorted by a valid keyholding member.
    </p>
    ...
    <p>No firearms, no drones. No leaving the hilltop. No generators. No running your car's engine while parked.</p>
